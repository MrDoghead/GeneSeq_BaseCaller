...
from bonito.core.optim.schedule import linear_warmup_cosine_decay
from bonito.utils.util import accuracy, decode_ref, permute, concat, match_names
from bonito.utils.io import CSVLogger
...
class Trainer:
    def __init__(
        ...
        save_optim_every=10, grad_accum_split=1, log_dir=None
    ):
        ...
        self.optimizer = None
        self.log_writer = SummaryWriter(os.path.join(log_dir,'logs')) if log_dir else None
    ...
    def train_one_epoch(self, loss_log, lr_scheduler):
        ...
        with progress_bar:
            ...
            for batch in self.train_loader:
                ...
                if self.log_writer and step % 1000 == 0:
                    self.log_writer.add_scalar('loss',smoothed_loss,step)
