...
from bonito.models.transformer.modules.transformer_utils import form_attention_mask
from bonito.models.transformer.modules.transformer_modules import MultiHeadAttention, PositionWiseFF
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, encoder_states, encoder_mask=None, encoder_mems_list=None, return_mems=False):
        """
        Args:
        ...
        if encoder_mask is None:
            B,L,H = encoder_states.shape
            encoder_mask = torch.ones((B,L)).to(encoder_states.device)
