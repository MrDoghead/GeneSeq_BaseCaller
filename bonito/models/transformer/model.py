import torch
import numpy as np
from bonito.models.common.nn import Module, Convolution, LinearCRFEncoder, Serial, Permute, layers, from_dict
...
from bonito.models.transformer.modules.transformer_encoders import TransformerEncoder
...
class Model(SeqdistModel):
    ...
    def __init__(self, config):
        ...
        if 'type' in config['encoder']: #new-style config
            ...
            encoder = trans_encoder(seqdist.n_base, seqdist.state_len, insize=config['input']['features'], **config['encoder'])
